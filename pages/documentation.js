        ...
        <div className="">
            <div className="container px-3 mx-auto flex flex-wrap flex-col md:flex-row items-center">
                <div className="flex flex-col w-full justify-center text-center md:w-2/5 md:text-left bg-gradient-to-r from-green-400 to-blue-500">
                    ...
                    <h1 className="my-4 text-5xl text-primary font-extrabold leading-tight text-center">Example</h1>
                    <p className="leading-normal text-xl text-accents-3 mb-8 text-center">Lorem ipsum</p>
